...
Modulo per generare la Certificazione Unica

**English**

Module to generate the single certification
...
Per configurare le tipologie di reddito, occorre che siano correttamente valorizzate le causali di pagamento

Contabilità →  Configurazione →  Ritenuta d'acconto

**Inglese**

You can configure income type through reason payment into withholding tax

Accounting →  Configuration →  Withholding Tax
